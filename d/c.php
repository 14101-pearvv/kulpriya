...
<div class="container">
    <div class="form-container">
        <h1 class="text-center mb-4 text-primary">ฟอร์มสมัครสมาชิก <br> กุลปริยา แก้วตา (แพรว) - Gemini </h1>
        ...
        if (isset($_POST['Submit'])){
            ...
            echo "<h3 class='text-success'>ข้อมูลที่ส่ง :</h3>";
            echo "<ul class='list-group'>";
            echo "<li class='list-group-item'>ชื่อ-สกุล : ". htmlspecialchars($fullname)."</li>";
            echo "<li class='list-group-item'>เบอร์โทร : ". htmlspecialchars($phone)."</li>";
            echo "<li class='list-group-item'>ความสูง : ". htmlspecialchars($height). " ซม.</li>";
            echo "<li class='list-group-item d-flex justify-content-between align-items-center'>สีที่ชอบ : ". htmlspecialchars($color)." <div style='width: 30px; height: 30px; border-radius: 50%; background:{$color}; border: 1px solid #ccc;' title='สีที่เลือก'></div></li>";
            echo "<li class='list-group-item'>สาขาวิชา : ". htmlspecialchars($major)."</li>";
            echo "</ul>";
        }
        ?>
    </div>
