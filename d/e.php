...
<div class="container">
    <div class="card card-application border-0">
        <div class="card-body">
            ...
            <form method="post" action="f.php" method="post">
                <div class="mb-4">
    ...
    <div class="container mt-5">
        ...
        if (isset($_POST['Submit'])){
            ...
            echo "<h4 class='alert-heading'><i class='bi bi-check-circle-fill me-2'></i>ส่งข้อมูลสำเร็จ!</h4>";
            echo "<p>ขอบคุณคุณ " . htmlspecialchars($_POST['fullname']) . " ที่ให้ความสนใจในตำแหน่ง " . htmlspecialchars($_POST['position']) . "</p>";
            echo "<hr>";
            echo "<p class='mb-0'>ข้อมูลที่ได้รับ : </p>";
            echo "<ul class='list-unstyled'>";
            echo "<li><i class='bi bi-caret-right-fill'></i> คำนำหน้าชื่อ : " . htmlspecialchars($_POST['prefix']) . "</li>";
            echo "<li><i class='bi bi-caret-right-fill'></i> วัน/เดือน/ปีเกิด : " . htmlspecialchars($_POST['dob']) . "</li>";
            echo "<li><i class='bi bi-caret-right-fill'></i> ระดับการศึกษา : " . htmlspecialchars($_POST['education']) . "</li>";
            echo "<li><i class='bi bi-caret-right-fill'></i> ทักษะเด่น : " . nl2br(htmlspecialchars($_POST['skills'])) . "</li>";
            echo "<li><i class='bi bi-caret-right-fill'></i> ประสบการณ์ : " . nl2br(htmlspecialchars($_POST['experience'])) . "</li>";
            echo "</ul>";
            echo "</div>";
        }
        ?>
