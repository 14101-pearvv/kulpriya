...
<h1>ข้อมูลภาค -- กุลปริยา แก้วตา (แพรว)</h1>
...
?>
    <tr>
        ...
        <td width="50" align="center"><a href="delete_region.php?id=<?php echo $data['r_id'];?>" onClick="return confirm ('ยืนยันการลบ?');"><img src="images/delete.png" width="20"></td>
    </tr>
